...
public:
    ...
    Contact *update(string w1, string w2, string old_pno, string new_pno)
    {
        ...
        if (temp->person)
            temp->person->updatePNo(old_pno, new_pno);
    ...
    while (1)
    {
        ...
        switch (opt)
        {
            case 1:
            {
                ...
                cout << endl
                    << "Contact Created Successfully!!" << endl;
                break;
            }
            ...
            case 2:
            {
                ...
                cout << endl
                    << "Phone Number added to Contact Successfully!" << endl;
                break;
            }
